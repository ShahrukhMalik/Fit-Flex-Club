...
class FitFlexClientChatWindowPage extends StatefulWidget {
  ...
  const FitFlexClientChatWindowPage({
    super.key,
    this.chat,
  });

  @override
  State<FitFlexClientChatWindowPage> createState() =>
      _FitFlexClientChatWindowPageState();
}
    ...
    return GestureDetector(
      ...
      child: PopScope(
        ...
        child: Scaffold(
          ...
          body:
              // BlocConsumer<GetChatCubit, GetChatState>(
                        ...
                        if (widget.chat != null) {
                          ...
                          if (messages.isNotEmpty) {
                            ...
                            for (var msg in messages) {
                              ...
                              if (lastDate != msgDate) {
                                groupedItems.add(
                                    '__DATE__${msg.timestamp.toIso8601String()}');
                                lastDate = msgDate;
                              }
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (item is String &&
                                    item.startsWith('__DATE__')) {
                                  final date = DateTime.parse(
                                      item.replaceFirst('__DATE__', ''));
                            ...
                            child: BackdropFilter(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: const Text(
                                    'Chat is not yet initiated from trainer...',
                                    style: TextStyle(
                                      fontSize: 16,
                    ...
                    children: [
                      Expanded(
                        child: AppTextFields.prefixSuffixTextField(
                          ...
                          filledColor: globalColorScheme.onPrimaryContainer
                              .withOpacity(1),
                          style: TextStyle(
                            color: globalColorScheme.primary,
                          ),
