...
class BaseExercise extends Table {
  ...
  BoolColumn get reps => boolean().withDefault(Constant(false))(); // Defaults to true
  BoolColumn get duration => boolean().withDefault(Constant(false))(); // Defaults to false
  BoolColumn get weight => boolean().withDefault(Constant(false))(); // Defaults to true
