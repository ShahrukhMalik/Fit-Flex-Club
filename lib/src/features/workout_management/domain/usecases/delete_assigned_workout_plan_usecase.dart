...
abstract class DeleteAssignedWorkoutPlanUsecase extends WorkoutPlanManagementUsecase
...
@Singleton(as: DeleteAssignedWorkoutPlanUsecase)
class DeleteAssignedWorkoutPlanUsecaseImpl extends DeleteAssignedWorkoutPlanUsecase {
  final WorkoutManagementRepository workoutManagementRepository;

  DeleteAssignedWorkoutPlanUsecaseImpl({required this.workoutManagementRepository});

  @override
  Future<Either<Failures, void>>? call(Params params) {
    return workoutManagementRepository.deleteAssignedWorkoutPlan(params.workoutPlan);
  }
}
