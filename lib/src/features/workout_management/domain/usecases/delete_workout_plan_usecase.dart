...
abstract class DeleteWorkoutPlanUsecase extends WorkoutPlanManagementUsecase
...
@Singleton(as: DeleteWorkoutPlanUsecase)
class DeleteWorkoutPlanUsecaseImpl extends DeleteWorkoutPlanUsecase {
  final WorkoutManagementRepository workoutManagementRepository;

  DeleteWorkoutPlanUsecaseImpl({required this.workoutManagementRepository});

  @override
  Future<Either<Failures, void>>? call(Params params) {
    return workoutManagementRepository.deleteWorkoutPlan(params.workoutPlan);
  }
}
