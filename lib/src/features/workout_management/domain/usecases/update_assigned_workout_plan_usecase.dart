...
abstract class UpdateAssignedWorkoutPlanUsecase extends WorkoutPlanManagementUsecase
...
@Singleton(as: UpdateAssignedWorkoutPlanUsecase)
class UpdateAssignedWorkoutPlanUsecaseImpl extends UpdateAssignedWorkoutPlanUsecase {
  final WorkoutManagementRepository workoutManagementRepository;

  UpdateAssignedWorkoutPlanUsecaseImpl({required this.workoutManagementRepository});

  @override
  Future<Either<Failures, void>>? call(Params params) {
    return workoutManagementRepository.updateAssignedWorkoutPlan(params.workoutPlan);
  }
}
