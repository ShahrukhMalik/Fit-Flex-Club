...
class CustomPhoneField extends StatefulWidget {
  ...
  final String? Function(String) onCountrySelect;
...
class _CustomPhoneFieldState extends State<CustomPhoneField> {
  ...
  final ValueNotifier<List<Map<String, String>>> filteredCountryCodes =
      ValueNotifier([]);
  final ValueNotifier<String> _selectedCountryCode = ValueNotifier('');

  @override
  void initState() {
    super.initState();
    filteredCountryCodes.value = Countries.allCountries;
    _selectedCountryCode.value = '+92'; // Default country code
    _searchController.addListener(_filterCountryCodes);
  }
  ...
  void _filterCountryCodes() {
    ...
    print(filteredCountryCodes);
  }

  void _onCountrySelect(String code) {
    _selectedCountryCode.value = code;
    widget.onCountrySelect(code);
  ...
  Widget build(BuildContext context) {
    return Platform.isIOS
        ? _buildCupertinoPhoneField()
        : _buildMaterialPhoneField();
  }

  // Cupertino (iOS) style phone field
  Widget _buildCupertinoPhoneField() {
    return Row(
      children: [
        GestureDetector(
  ...
  // Material (Android) style phone field
  Widget _buildMaterialPhoneField() {
    return Row(
      children: [
        GestureDetector(
          onTap: () => _showCountryCodePicker(context),
